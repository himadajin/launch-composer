...
- ファイル: [communication.md](./communication.md)
...
- details: contract map は [contracts/json-files.md](../contracts/json-files.md)、Generate 時 validation は [core.md](./core.md)
...
- details: contract map は [contracts/json-files.md](../contracts/json-files.md)、merge / validation は [core.md](./core.md)
...
- details: path resolution / precedence は [core.md](./core.md)

`args` 以外のキーは生成に使わない。メタデータとして自由に含めてよい。`argsFile` のパス解決と結合順序は [core.md](./core.md) を参照する。
...
- role: Generate の出力
- details: output order は [core.md](./core.md)、file write は [extension.md](./extension.md)

`launch.json` の生成ルール、確認ダイアログ、エラー処理は [extension.md](./extension.md) と [core.md](./core.md) を参照する。
