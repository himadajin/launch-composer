...
JSON file data と Generate 入出力の shape は `packages/core/src/types.ts` を canonical source とする。契約ごとの参照先は [JSON file data contract map](../contracts/json-files.md) を参照する。
